...
|-------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|----------------------------------------------------|
| 1     | [Kayak](https://github.com/YoannRobert/rncp-ml-engineer/blob/main/bloc1/Kayak) — destination & hotel recommendation pipeline                                | Data engineering (ETL)         | Scrapy · AWS S3 · AWS RDS PostgreSQL · SQLAlchemy  |
| 2     | [Steam](https://github.com/YoannRobert/rncp-ml-engineer/blob/main/bloc2/Steam) — drivers of video-game success                                              | EDA (big data)                 | PySpark · Databricks                               |
| 2     | [Tinder](https://github.com/YoannRobert/rncp-ml-engineer/blob/main/bloc2/Tinder) — what motivates a second date                                             | EDA                            | pandas · Plotly · statsmodels                      |
| 3     | [Conversion Rate Challenge](https://github.com/YoannRobert/rncp-ml-engineer/blob/main/bloc3/Conversion_Rate_Challenge) — newsletter subscription prediction | Supervised ML (classification) | scikit-learn · XGBoost · Plotly                    |
| 3     | [Uber Pickups](https://github.com/YoannRobert/rncp-ml-engineer/blob/main/bloc3/Uber_Pickups) — demand hot zones in New York                                 | Unsupervised ML (clustering)   | scikit-learn · GeoPandas · Plotly                  |
